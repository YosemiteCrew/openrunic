 ...
 *
 * Everything else is deliberately optional. OpenEMR demanded fields the
...
export function RegisterPatientScreen({ client }: RegisterPatientScreenProps = {}): ReactElement {
  ...
  return (
    ...
    >
      ...
      {blocked ? (
        <p className="or-body or-register__blocked" role="status">
