...
export interface LoadingStateProps {
   ...
   *
   * Already translated when it arrives. It lands inside a translated sentence,
   * and the screen that is waiting is the only thing that knows which of its
   * regions this skeleton stands in for.
   */
  label: string;
