...
/**
 * The analytes of the panel above, in wire shape.
 *
 * Only the lab report has them: the imaging report reads as a narrative, which
 * is the distinction the reading pane draws, and an imaging study with a value
 * table would make that distinction untestable. One in range and one out, so a
 * caller can tell a mapped flag from a hard-coded one, and the third carries no
 * unit at all - a qualitative analyte is how an observation legitimately has
 * nothing to put beside its value.
 */
export const MOCK_RESULT_OBSERVATIONS: readonly ResultObservationDto[] = [
  {
    id: '0192f1a0-0000-7000-8000-00000000v001',
    diagnosticReportId: '0192f1a0-0000-7000-8000-00000000r001',
    patientId: FIRST_PATIENT,
    status: 'FINAL',
    sequence: 1,
    loincCode: '2823-3',
  ...
  {
    id: '0192f1a0-0000-7000-8000-00000000v002',
    diagnosticReportId: '0192f1a0-0000-7000-8000-00000000r001',
    patientId: FIRST_PATIENT,
    status: 'FINAL',
    sequence: 2,
    ...
    referenceLow: 135,
    referenceHigh: 145,
    referenceRangeText: '135 - 145 mmol/L',
  ...
  {
    id: '0192f1a0-0000-7000-8000-00000000v003',
    diagnosticReportId: '0192f1a0-0000-7000-8000-00000000r001',
    patientId: FIRST_PATIENT,
    status: 'FINAL',
    sequence: 3,
