 ...
 * server renders one language and the client hydrates into another, which
 * React reports as a hydration mismatch and a reader experiences as the page
 * changing language under them.
 */
