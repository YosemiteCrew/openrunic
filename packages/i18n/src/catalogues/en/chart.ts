...
export const chart: Messages = {
  ...
  'chart.medicationSource.reported': 'Patient reported',
  'chart.medicationSource.prescribed': 'Prescribed',
  'chart.medicationSource.reconciled': 'Reconciled',
  'chart.medicationSource.imported': 'Imported',
  'chart.medicationSource.unrecognised': 'Unrecognised source',
  'chart.medicationStatus.active': 'Active',
  'chart.medicationStatus.completed': 'Completed',
  'chart.medicationStatus.enteredInError': 'Entered in error',
  'chart.medicationStatus.intended': 'Intended',
  'chart.medicationStatus.notTaken': 'Not taken',
  'chart.medicationStatus.onHold': 'On hold',
  'chart.medicationStatus.stopped': 'Stopped',
  'chart.medicationStatus.unknown': 'Unknown',
  'chart.medicationStatus.unrecognised': 'Unrecognised state',
  ...
  'chart.medications.column.status': 'Status',
  'chart.medications.notActive.title': 'Not currently active',
  'chart.medications.notActive.caption': 'Medications that are not active, with the state of each',
