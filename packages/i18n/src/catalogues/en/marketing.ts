 ...
 * THE PUBLIC PAGES.
 *
 * Four pages a stranger reads before they trust anything: the home page and one
 * per audience. Nothing here is clinical, and every claim on these pages is
 * checked against the file that makes it true, so a translator is translating
 * statements of fact rather than persuasion.
 *
 * Keys are grouped by page, then by the band they sit in, because that is the
 * order somebody reviewing the site reads them in. The shared chrome - the
 * masthead, the footer, the pillar cards, the repeated call-to-action labels -
 * comes first, since it appears on all four.
 */
export const marketing: Messages = {
  ...
  'marketing.header.nav': 'Site',
  'marketing.nav.hospitals': 'Hospitals',
  'marketing.nav.patients': 'Patients',
  'marketing.nav.developers': 'Developers',

  /* ---------------------------------------- link labels, shared across pages */
  'marketing.link.source': 'Source',
  'marketing.link.documentation': 'Documentation',
  'marketing.link.architecture': 'Architecture',
  'marketing.link.roadmap': 'Roadmap',
  'marketing.link.contributing': 'Contributing guide',
  'marketing.link.goodFirstIssues': 'Good first issues',
  'marketing.link.discussions': 'Discussions',
  'marketing.link.conduct': 'Code of conduct',
  'marketing.link.licence': 'Licence: AGPL-3.0-only',
  'marketing.link.compliance': 'Regulatory posture',
  'marketing.link.security': 'Security policy',
  'marketing.link.decisions': 'Architecture decisions',
  'marketing.link.readTheSource': 'Read the source',
  'marketing.link.gettingStarted': 'Getting started',
  'marketing.link.apiDesign': 'API design',
  'marketing.link.selfHosting': 'How self-hosting will work',
  'marketing.link.patientPortal': 'How the portal works',
  'marketing.link.readDecisions': 'Read the architecture decision records',
  'marketing.link.readCompliance': 'Read the full regulatory posture',
  'marketing.link.readArchitecture': 'Read the architecture overview',
  ...
  'marketing.footer.column.project': 'Project',
  'marketing.footer.column.contribute': 'Contribute',
  'marketing.footer.column.governance': 'Governance',
  /* The compliance footnote stays on every public page: the regulatory position
     is not something a reader has to click into. */
  ...
  /* ---------------------------------------------------------- the audiences */
  /* The card's link is named for the audience rather than "Read more", because
     three identically named links are three identical rows in a screen reader's
     link list. `{audience}` is the pillar's own title, lower cased. */
  'marketing.pillar.link': 'openrunic for {audience}',
  ...
  'marketing.home.title': 'Open-source operating system for human health',
  'marketing.home.lead':
  ...
  'marketing.home.status.label': 'Where the project is',
  ...
  'marketing.home.foundation.relational.title': 'Relational storage, FHIR at the edge',
  ...
  'marketing.home.foundation.audit.title': 'Audit is structural, not additive',
  ...
  'marketing.home.foundation.telemetry.title': 'Nothing phones home',
  ...
  'marketing.home.foundation.content.title': 'No vendored content, no bundled models',
  ...
  'marketing.hospitals.status.label': 'What you can run today',
  ...
  'marketing.patients.status.label': 'What this means today',
  ...
  'marketing.patients.ownership.privacy.title': 'You are not the product',
  ...
  'marketing.developers.status.label': 'Stability',
  ...
  'marketing.developers.boundary.fhir.title': 'FHIR R4, advertising only what it can answer',
  ...
  'marketing.developers.agent.defaultOff.title': 'Default off, and genuinely separable',
