...
export const portal: Messages = {
  ...
  /* Voice controls */
  'portal.assistant.voice.start': 'Start voice input',
  'portal.assistant.voice.stop': 'Stop voice input',
  'portal.assistant.voice.pause': 'Pause voice input',
  'portal.assistant.voice.resume': 'Resume voice input',
  'portal.assistant.voice.listening': 'Listening...',
  'portal.assistant.voice.paused': 'Voice input paused',
  'portal.assistant.voice.error': 'Voice input could not start. Check microphone permissions.',
  'portal.assistant.voice.notSupported': 'Voice input is not supported in this browser.',
  'portal.assistant.voice.typedAlternative': 'Or type your question instead',
  'portal.assistant.captions.label': 'Live captions',
  'portal.assistant.captions.empty': 'Captions will appear here as you speak',
